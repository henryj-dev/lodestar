...
ALTER TABLE "user_service_entitlements" ADD CONSTRAINT "user_service_entitlements_assignment_id_user_service_assignments_id_fk" FOREIGN KEY ("assignment_id") REFERENCES "public"."user_service_assignments"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_service_entitlements" ADD CONSTRAINT "user_service_entitlements_service_entitlement_id_service_entitlements_id_fk" FOREIGN KEY ("service_entitlement_id") REFERENCES "public"."service_entitlements"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
