...
export const userClientConsents = pgTable(
    "user_client_consents",
    {
        ...
        grantedAt: timestamp("granted_at", { mode: "date", withTimezone: true, precision: 3 })
            .notNull()
            .$defaultFn(() => new Date()),
        revokedAt: timestamp("revoked_at", { mode: "date", withTimezone: true, precision: 3 }),
    },
 ...
 */
export const clientTerms = pgTable(
    "client_terms",
    {
        id: text("id")
            .primaryKey()
 ...
 * 낮은지로 한다.
 */
export const userTermAgreements = pgTable(
    "user_term_agreements",
    {
        ...
        agreedAt: timestamp("agreed_at", { mode: "date", withTimezone: true, precision: 3 })
            .notNull()
            .$defaultFn(() => new Date()),
    },
